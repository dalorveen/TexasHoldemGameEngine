namespace TexasHoldem.AI.Champion.Tests.PokerMath
{
    ...
    public class CalculatorTests
    {
        ...
        {
            var mockedPocket = new Mock<ICardAdapter>();
            var pockets = new List<ICardAdapter> { mockedPocket.Object };
        ...
        {
            var mockedPocket = new Mock<ICardAdapter>();
            var pockets = new List<ICardAdapter> { mockedPocket.Object, mockedPocket.Object };
        ...
        public void EquityShouldReturnCorrectValue()
        {
            ...
            */
            ...
            var pockets = new List<ICardAdapter>();
