namespace TexasHoldem.Statistics.Indicators
{
    ...
    public class ThreeBet : BaseIndicator
    {
        ...
        public ThreeBet(int hands, StreetStorage totalTimes, StreetStorage totalOpportunities)
            : this(hands)
        {
        ...
        /// <summary>
        /// The percentage of time a player re-raised a raiser on the (pre-flop/flop/turn/river)
        /// </summary>
        /// <param name="street">Street</param>
        /// <returns>Percentages of 3Bet on the street</returns>
        ...
        {
            return $"ThreeBet:[PF|{this.Percentage(GameRoundType.PreFlop):0.00}%] " +
