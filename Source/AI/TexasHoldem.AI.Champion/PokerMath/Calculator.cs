namespace TexasHoldem.AI.Champion.PokerMath
{
    ...
    {
        private readonly ICollection<ICardAdapter> pockets;

        private readonly ulong dead;

        private readonly ulong communityCards;

        public Calculator(ICollection<ICardAdapter> pockets, ICollection<Card> dead, ICollection<Card> communityCards)
        {
            if (pockets == null)
            {
