        ...
        public Champion(PlayerStyles style, int buyIn)
        {
            ...
            switch (style)
            {
                ...
                case PlayerStyles.LOOSE_AGGRESSIVE:
                    ...
                    cbet.Add(GameRoundType.Flop, new CBet(this.Name, 1000, 60, 1000));
                    cbet.Add(GameRoundType.Turn, new CBet(this.Name, 1000, 58, 1000));
                    cbet.Add(GameRoundType.River, new CBet(this.Name, 1000, 41, 1000));
                    playingStyle.CBet = new StreetStorage<CBet>(cbet);

                    var afq = new Dictionary<GameRoundType, AFq>(3);
                    afq.Add(GameRoundType.Flop, new AFq(1000, 100, 198, 0));
                    afq.Add(GameRoundType.Turn, new AFq(1000, 100, 158, 0));
                    afq.Add(GameRoundType.River, new AFq(1000, 100, 300, 0));
